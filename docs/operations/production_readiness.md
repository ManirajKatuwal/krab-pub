...
- Latest certification index generated by `krab release certify`: `internal/audit/release-certify/latest.md` (local/CI artifact, not committed)
...
- Required CI and audit evidence recorded in `internal/reports/PRE_RELEASE_AUDIT_REPORT.md` (internal).
- Latest certification bundle indexed in `internal/audit/release-certify/latest.md` (internal).
- Rollback evidence recorded in `internal/audit/evidence/rollback-rehearsal-evidence.txt` (internal).
