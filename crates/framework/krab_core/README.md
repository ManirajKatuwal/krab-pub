...
Shared runtime for the [Krab](https://github.com/ManirajKatuwal/krab-pub) full-stack
Rust web framework.
...
- [Architecture deep-dive](https://github.com/ManirajKatuwal/krab-pub/blob/main/docs/architecture/design.md)
- [Environment reference](https://github.com/ManirajKatuwal/krab-pub/blob/main/docs/reference/environment.md)
- [Database and migration governance](https://github.com/ManirajKatuwal/krab-pub/blob/main/docs/reference/database.md)
