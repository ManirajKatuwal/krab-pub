...
Procedural macros for the [Krab](https://github.com/krab-framework/krab)
...
- [Server functions](https://github.com/krab-framework/krab/blob/main/docs/reference/server_functions.md)
- [ADR 0003 — server functions as public endpoints](https://github.com/krab-framework/krab/blob/main/docs/adr/0003-server-functions-public-endpoints.md)
